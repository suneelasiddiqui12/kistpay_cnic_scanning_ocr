...
class CnicBackView extends StatefulWidget {
  const CnicBackView({super.key});

  @override
  State<CnicBackView> createState() => _CnicFrontViewState();
}

class _CnicFrontViewState extends State<CnicBackView> {
  @override
                ...
                children: [
                  ...
                  _buildImagePickerButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => CaptureSelfie()),
                      );
                    },
                  ),
                ],
